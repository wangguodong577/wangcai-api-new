...
|---|---|---|---|---|
|words|字符串|配文字|是|xxx|
|noteId|字符串|照片id|是|asdf2jr2ojflajfjlkajfsdfsaf|
####成功返回值
```
{
    "ret": 200,
...
##聊天接口
###使用运营帐号TeamNuzzle发送消息接口
####接口:/chat/send
####请求方式:GET/POST
####接口参数
|参数名|类型|描述|是否必须|示例|
|---|---|---|---|---|
|content|字符串|消息正文|是|hello|
|receiverIds|接收人，用英文的逗号分隔，如果不是群发，则此字段必须|是|ssssss,dddddd,ffffff|
|all|布尔值|是否群发，为true时群发，否则只发给指定的人|是|false|
####成功返回值
```
{
    "ret": 200,
